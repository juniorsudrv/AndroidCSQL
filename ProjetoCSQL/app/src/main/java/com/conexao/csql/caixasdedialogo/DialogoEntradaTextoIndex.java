...
public class DialogoEntradaTextoIndex {

	MainActivity pri;

	public DialogoEntradaTextoIndex(final MainActivity pri, String titulo, int index){
		...
		View promptsView = li.inflate(R.layout.dialogoentradatexto, null);
				...
				.setPositiveButton("OK",
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
                                                int id) {
							 acaoRetorno(userInput.getText().toString(), index);
