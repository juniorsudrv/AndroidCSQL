...
import com.conexao.csql.Banco.Conexao;
...
public class Banco implements Cloneable {
    ...
    public String uuid;
    public String mysql = "mercadoa_agricolaapp";
    public String bdNomeL = "mercadoa_agricolaapp";
    public String bdNome;
// public String host = "servertestes.ddns.net";
     public String host = "162.144.61.158";
    public String porta = "3306";
  String usuarioBanco = "mercadoagrcola";
    //   String usuarioBanco = "Usuario";
    public String senha = "(,Ke(O#?1K?x";
    /*
    ...
    public MainActivity pri=null;
    public boolean conectou=false;


    public Banco(MainActivity pri,boolean exe) {
        bdNome = mysql;
        this.pri=pri;
        abreBanco();
